...
df_hourly_danceability_average = pd.read_csv("data/hourlyStreamingAll/dfHourlyDanceabilityAverage.csv")

# Extract values from df_hourly_valence_non_average
values = df_hourly_danceability_average['averageDanceabilityScore'].tolist()
...
hourly_danceability_all = (c1 + c2).properties(width=400, height=400)
hourly_danceability_all