...
df_hourly_valence_average = pd.read_csv("data/hourlyStreamingAll/dfHourlyValenceAverage.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_valence_average['averageValenceScore'].tolist()
...
radial_chart_valence_average_all = (c1 + c2).properties(width=400, height=400)