...
# Load the file 
df_hourly_track_count = pd.read_csv("data/hourlyStreamingAll/dfHourlyTrackCount.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_track_count['trackCount'].tolist()
...
radial_chart_songs_count_hour_all = (c1 + c2)
