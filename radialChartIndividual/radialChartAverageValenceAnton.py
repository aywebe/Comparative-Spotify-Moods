...
df_hourly_valence_average_anton = pd.read_csv("data/hourlyStreamingIndividual/dfHourlyValenceAverageAnton.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_valence_average_anton['averageValenceScore'].tolist()
...
radial_chart_average_valence_anton = (c1 + c2).properties(width=400, height=400)