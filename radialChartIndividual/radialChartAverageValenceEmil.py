...
df_hourly_valence_average_emil = pd.read_csv("data/hourlyStreamingIndividual/dfHourlyValenceAverageEmil.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_valence_average_emil['averageValenceScore'].tolist()
...
radial_chart_average_valence_emil = (c1 + c2).properties(width=400, height=400)