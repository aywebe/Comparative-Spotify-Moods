...
df_hourly_valence_average_laura = pd.read_csv("data/hourlyStreamingIndividual/dfHourlyValenceAverageLaura.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_valence_average_laura['averageValenceScore'].tolist()
...
radial_chart_average_valence_laura = (c1 + c2).properties(width=400, height=400)