...
# Load the file 
df_hourly_track_count_anton = pd.read_csv("data/hourlyStreamingIndividual/dfTrackCountAnton.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_track_count_anton['trackCount'].tolist()
...
radial_chart_songs_count_hour_anton = (c1 + c2)
