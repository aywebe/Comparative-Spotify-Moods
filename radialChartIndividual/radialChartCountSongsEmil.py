...
# Load the file 
df_hourly_track_count_emil = pd.read_csv("data/hourlyStreamingIndividual/dfTrackCountEmil.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_track_count_emil['trackCount'].tolist()
...
radial_chart_songs_count_hour_emil = (c1 + c2)
