...
# Load the file 
df_hourly_track_count_freyja = pd.read_csv("data/hourlyStreamingIndividual/dfTrackCountFreyja.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_track_count_freyja['trackCount'].tolist()
...
radial_chart_songs_count_hour_freyja = (c1 + c2)
