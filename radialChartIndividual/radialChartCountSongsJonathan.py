...
# Load the file 
df_hourly_track_count_jonathan = pd.read_csv("data/hourlyStreamingIndividual/dfTrackCountJonathan.csv")

# Extract values from df_hourly_valence_avereage
values = df_hourly_track_count_jonathan['trackCount'].tolist()
...
radial_chart_songs_count_hour_jonathan = (c1 + c2)
