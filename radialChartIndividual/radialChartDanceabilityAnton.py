...
df_hourly_danceability_average_anton = pd.read_csv("data/hourlyStreamingIndividual/dfHourlyDanceabilityAverageAnton.csv")

# Extract values from df_hourly_valence_non_average
values = df_hourly_danceability_average_anton['averageDanceabilityScore'].tolist()
...
radial_chart_hourly_danceability_anton = (c1 + c2).properties(width=400, height=400)