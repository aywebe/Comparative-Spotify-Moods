...
df_hourly_danceability_average_emil = pd.read_csv("data/hourlyStreamingIndividual/dfHourlyDanceabilityAverageEmil.csv")

# Extract values from df_hourly_valence_non_average
values = df_hourly_danceability_average_emil['averageDanceabilityScore'].tolist()
...
radial_chart_hourly_danceability_emil = (c1 + c2).properties(width=400, height=400)