...
df_hourly_danceability_average_laura = pd.read_csv("data/hourlyStreamingIndividual/dfHourlyDanceabilityAverageLaura.csv")

# Extract values from df_hourly_valence_non_average
values = df_hourly_danceability_average_laura['averageDanceabilityScore'].tolist()
...
radial_chart_hourly_danceability_laura = (c1 + c2).properties(width=400, height=400)