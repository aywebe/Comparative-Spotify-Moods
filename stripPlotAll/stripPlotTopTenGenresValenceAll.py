...
strip_plot_valence_artist_genres_all = alt.Chart(df_genres_clean_40).mark_circle(size=30).encode(
    ...
    # yOffset="jitter:Q",
    # TODO: Let color be dependent on both valenceScore and danceability 
